...
print("Valid moves?\t= " +
      ("WORKS!" if set(king2.get_valid_moves()) == set([(3,5), (2,5), (2,6), (2,7), (3,7), (4,7), (4,6), (4,5)]) else "Failed") +
...
print("Valid moves?\t= " +
      ("WORKS!" if set(knight2.get_valid_moves()) == set([(4,7), (5,6), (5,4), (4,3), (2,3), (1,4), (1,6), (2,7)]) else "Failed") +
...
print("Valid moves?\t= " +
      ("WORKS!" if set(bishop2.get_valid_moves()) == set([(0,7), (1,6), (7,6), (2,5), (6,5), (3,4), (5,4), (3,2), (5,2), (2,1), (6,1), (1,0), (7,0)]) else "Failed") +
...
print("Valid moves?\t= " +
      ("WORKS!" if set(rook2.get_valid_moves()) == set([(5,3), (6,3), (7,3), (3,3), (2,3), (1,3), (0,3), (4,4), (4,5), (4,6), (4,7), (4,2), (4,1), (4,0)]) else "Failed") +
...
print("Valid moves?\t= " +
      ("WORKS!" if set(queen1.get_valid_moves()) == set([(0,0), (0,4), (1,1), (1,3), (3,1), (3,3), (4,0), (4,4), (0,2), (1,2), (3,2), (4,2), (2,0), (2,1), (2,3), (2,4)]) else "Failed") +
...
print("Valid moves?\t= " +
      ("WORKS!" if set(queen2.get_valid_moves()) == set([(0,7), (1,6), (7,6), (2,5), (6,5), (3,4), (5,4), (3,2), (5,2), (2,1), (6,1), (1,0), (7,0), (5,3), (6,3), (7,3), (3,3), (2,3), (1,3), (0,3), (4,4), (4,5), (4,6), (4,7), (4,2), (4,1), (4,0)]) else "Failed") +
